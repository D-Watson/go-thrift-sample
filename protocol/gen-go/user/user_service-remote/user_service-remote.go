...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  void updateUser(User user)")
	fmt.Fprintln(os.Stderr, "   getAllUsers()")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "getAllUsers":
		if flag.NArg() - 1 != 0 {
			fmt.Fprintln(os.Stderr, "GetAllUsers requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.GetAllUsers(context.Background()))
		fmt.Print("\n")
		break
	case "":
		Usage()
